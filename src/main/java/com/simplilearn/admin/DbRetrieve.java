...
import com.simplilearn.models.Classdb;
public class DbRetrieve {
	...
	public List<Classdb> getClasses() {

		List<Classdb> classes = new ArrayList<>();
		...
		try {
			...
			while (myRs.next()) {
				...
				// create new student object
				Classdb temp = new Classdb(id, section, teacher_name, tempSubject.getName(), time);
	...
	public Classdb loadClass(int classId) {

		Classdb theClass = null;
